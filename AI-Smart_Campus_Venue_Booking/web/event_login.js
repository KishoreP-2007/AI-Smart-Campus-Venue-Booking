...
/* ---------- LOGIN ---------- */
window.loginEvent = async function () {
  ...
  try {
    ...
    if (!userDoc.exists() || userDoc.data().role !== "event") {
      msg.innerText = "Access denied: Not an event team account";
      return;
    }
...
window.resetPassword = async function () {
  ...
  try {
    // Silent login with old password
